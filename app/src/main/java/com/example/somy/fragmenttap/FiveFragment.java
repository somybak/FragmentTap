...
public class FiveFragment extends Fragment {
    ...
    public static FiveFragment newInstance(int columnCount) {
        ...
        return fragment; // send to object
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // 카메라 처리
        btnCamera = (ImageButton) view.findViewById(R.id.imageButton);
...
//                recyclerView.setLayoutManager(new GridLayoutManager(context, mColumnCount));
//            }
//            recyclerView.setAdapter(new MyItemRecyclerViewAdapter(getContext(), mListener));
//        }
//        return view;
    ...
    private View.OnClickListener clickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent intent = null;
            switch(v.getId()){
                case R.id.imageButton: //카메라 버튼 동작
